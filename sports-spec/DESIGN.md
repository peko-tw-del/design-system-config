# 七星體育 設計規範 v0.4.2 (component refresh)
...
輸入框 327x36,padding 12/10。按鈕高 42,padding 左8 右16 上下10。tab 高 40。滑塊 28。tab 指示條 22x3。一般 UI icon 尺度 12 / 16 / 20 / 24。外部圖像素材另有固定尺寸:隊伍名中的國家/聯賽隊徽 17x17,賽事 logo 22x22;插件只檢外層尺寸,不讀取內部圖像色彩。

---

## 02 Components(01-05 元件庫已更新,規格詳見 design-components.json)
...
| 01 共用基礎 Common | Balance Display / 結餘 | h32,radius/full,padding LR8,gap4,B100;金額 DIN 16/24,Secondary/score | size/radius + semantic color |
...
| 03 投注 Betting | BetAmountInput | 327x36,r4,padding 12/10;Empty/Filled 邊 Background/B20,Error Secondary/Error | size/padding/radius |
| 03 投注 Betting | Checkbox | 16x16,r4;State=on / State=off | size/radius/padding |
...
| 03 投注 Betting | OddsValue | DIN 14;Up/Down/locked/None/focus/focus up/focus down;None 與 focus 寬 24 | size/padding |
| 03 投注 Betting | amount_L / amount_S | L 58x14,S 27x14;Default/up/down/鎖頭/focus 系列 | size |
| 03 投注 Betting | 投注底部菜单 | 375w;Default 523,盤口失效 315,確認下注 407,已輸入金額 314 | size |
...
| 04 注单 Bet Orders | 注单 / Odds | 70x42;State=Down/Up/None | size |
| 04 注单 Bet Orders | 注单总计 / 注单 | 總計 351x65,r4,B70,padding 8/12;列表 351x161 | size/radius/padding |
| icon assets | 队伍名 / icon /  赛事 | 國家與聯賽隊徽 17x17;賽事 logo 22x22;外部圖像色彩不讀取 | size only |
| 05 通知中心 Notification | popup / popup icon / popup 我的 | r16;標準 343w、icon 版 300w;Button/Confirm 用 Main/B80 | size/radius + bg pending |
...
- 外部素材如國家旗、聯賽隊徽與賽事 logo 不套色彩白名單;只檢外層 17x17 / 22x22 尺寸。
- Balance Display 最大值 `238,114.00` 的上限仍待產品/設計確認;目前先以 Figma 狀態卡作 warning 規則。
- 通知中心仍同時存在舊 `通知中心 Notification` 與新 `彈窗 Pupop` 區塊;Popup 拼字與舊區是否退役待整理。
...
8. **同名元件集重複**:tab_btn 兩組(variant 值還一組 Focus 一組 focus)。amount 已在本地規範拆為 amount_L / amount_S,仍需 Figma 命名正式同步。
...
本版色彩白名單來自新版 foundation (`8359:14643`) 與 Figma Variables API / foundation metadata 讀取的 18 個 color variables。2026-07-13 已補讀 Common 區 Balance Display / 結餘狀態卡,並同步 `6863:293089` 元件更新與 `7870:260249` / `7870:260299` 素材尺寸。文字、間距、圓角與陰影已同步 foundation:spacing 4/6/8/10/12/16/20 + safe-bottom 34;radius 4/8/16/full;shadow/nav 與 shadow/pop-up window(舊名 bottom-bar)。外部圖像素材不讀色彩,但保留外層尺寸檢查。
